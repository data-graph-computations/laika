...
\usepackage{pgfplots}
\usepackage{sidecap} %use \begin{SCfigure}
\usepackage{wrapfig} %use \begin{wrapfigure}[lineheight]{position (r=right, l=left, i=inside, o=outside)}{width}
...
%
\title{6.886 Final Project: \\ Bigger and Faster Data-graph Computations for Physical Simulations}
%
